...
<div class="card mt-5 w-50 mx-auto">
    <div class="card-header">
        <h5>Modification d'un categorie</h5>
    </div>
    <div class="card-body bg-light">
            <form action="index.php?action=updateCategorie" method="post">
                ...
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="libelle" name="libelle" value="<?=$categorie['libelle']?>">
                </div>
